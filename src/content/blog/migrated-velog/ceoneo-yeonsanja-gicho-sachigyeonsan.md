...
draft: false
originalUrl: "https://velog.io/@siltarre/C언어-연산자-기초-사칙연산"
series: "C언어"
---

여러분, 지난 시간에 변수가 뭐다?  
“데이터 담는 상자”라고 했었죠.  
이제 그 상자 안의 값들을 꺼내서 더하고 빼고 곱하고 나눠볼 차례입니다.
...
※ `int`끼리 나누면 소수점은 싹 잘려서 정수만 남습니다.
...
※ `(double)a` 처럼 쓰면 정수 a를 잠깐 실수형으로 바꿔서 계산합니다.  
반대로 `(int)3.7` 은 3만 남고 .7은 잘려나갑니다. (반올림 아님!)
...
다음 시간에는 이 연산자들을 활용해서 **조건문(if문)**을 배워보겠습니다.  
조건에 따라 “다르게 행동하는 프로그램”을 만드는 거죠.
